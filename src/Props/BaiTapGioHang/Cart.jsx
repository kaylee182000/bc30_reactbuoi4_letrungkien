...
export default class Cart extends Component {
  render() {
    ...
    return (
      <div>
        <div className="modal fade" id="Cart" tabIndex={-1} role="dialog">
                    ...
                    {cart.map((item, index) => {
                      return (
                        <tr key={index}>
                          ...
                          <td>
                            <button
                              className="btn btn-success d-inlineblock me-2"
                              onClick={() => {
                            ...
                            {item.soLuong}
                            <button
                              className="btn btn-primary d-inlineblock ms-2"
                              onClick={() => {
                          ...
                          <td>
                            {(item.soLuong * item.giaBan).toLocaleString()} VND
                          </td>
                          <td>
                            <button
